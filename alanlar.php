	...
	<div class="container">
		<div class="row pt-xl">
			...
			<div class="col-md-9">
				...
				<h1 class="mt-xl mb-none">Hizmet Alanları</h1>
				...
				<div class="row">
					...
					$toplam_alanlar = $sorgu->rowCount();

					$toplam_sayfa = ceil($toplam_alanlar / $sayfada);
					...
					$alanlarsor=$db->prepare("select * from alanlar order by alanlar_ad DESC limit $limit,$sayfada");
					$alanlarsor->execute();
								...
								<span class="thumb-info-caption">
									<span class="thumb-info-caption-text">
										...
										<h2><a title="" class="text-dark" href="
											alanlar-<?=vfc($alanlarcek["alanlar_ad"]).'-'.$alanlarcek["alanlar_id"]?>"><?php echo $alanlarcek['alanlar_ad'
											]; ?></a></h2>
											</div>

										<div class="col-md-12">
											<span class="thumb-info-side-image-wrapper p-none">
												<a title="" href="alanlar-<?=vfc($alanlarcek["alanlar_ad"]).'-'.$alanlarcek["alanlar_id"]?>">
											...
											<div class="mb-md mt-xs" style="width: 100%; border-right: 0px; padding-left: 15px; padding-right: 15px; margin-top: -60px; text-align: justify;">
												<p class="font-size-md"><?php echo substr($alanlarcek['alanlar_detay'],0,127); ?>...</p>
											</div>
											<a style="float: right; position: relative; top: -21px; left: -31px;" class="mt-md" href="alanlar-<?=vfc($alanlarcek["alanlar_ad"]).'-'.$alanlarcek["alanlar_id"]?>"><strong>Daha Fazla </strong><i class="fa fa-arrow-right"></i></a>
										</span>
									</span>
								</span>
								...
								while ($s < $toplam_sayfa) {
									...
									if ($s==$sayfa) {?>
										...
										<li class="active">
											...
											<a href="alanlar?sayfa=<?php echo $s; ?>"><?php echo $s; ?>
										</a>
			...
			<aside class="sidebar">
				<div id="combinationFilters" class="filters">
					...
					<blockquote class="blockquote-secondary">
						<p class="font-size-lg"><?php echo $alanlarcek['alanlar_not']; ?></p>
					</blockquote>
