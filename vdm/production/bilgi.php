  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="color: #73879C;"><b>Sıkça Sorulanlar</b></h3>
      </div>
                  ...
                  <div class="x_title">
                    ...
                    <div class="x_content">
                      ...
                      <form action="../vst/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" style="margin: auto; width: 111%;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            name="bilgi_baslik" value="<?php echo $bilgicek['bilgi_baslik']; ?>" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        ...
                        <div class="form-group" style="display: flex; align-items: center;">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <textarea  class="ckeditor" id="editor1" name="bilgi_icerik"><?php echo $bilgicek['bilgi_icerik']; ?></textarea>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="border-radius: 20px;" type="text" id="first-name" required="required"
                          name="bilgi_video" value="<?php echo $bilgicek['bilgi_video']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" style="text-align: center; color: #F0AD4E;"> Kısa Metin <span class="required">*</span>
                        </label>

                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="border-radius: 20px;" type="text" id="first-name" required="required"
                          name="bilgi_not" value="<?php echo $bilgicek['bilgi_not']; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" name="bilgikaydet" class="btn btn-warning" style="color: #73879C; border-radius: 20px;"> Güncelle </button>
