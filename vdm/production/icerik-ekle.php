            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12" style="">
                <div class="x_panel" style="background-color: #D9DEE4; border-radius: 30px; text-align: center;">
                  <div class="x_title">
                    <h2 style="color: #73879C; text-align: left;">İçerik Ekle<small><?php
                    if ($_GET['durum']=='✓') {?> 
                    ...
                    <div class="x_content">
                      ...
                      <form action="../vst/islem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" style="margin: auto; width: 111%;">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            name="icerik_resimyol" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            name="icerik_ad" placeholder="İçerik Adını Giriniz..." class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="border-radius: 20px;" type="text" id="first-name" required="required"
                          name="icerik_keyword" placeholder="İçerik Keyword Giriniz..." class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input style="border-radius: 20px;" type="text" id="first-name" required="required"
                          name="icerik_sira" value="0" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        ...
                        <button type="submit" name="icerikkaydet" class="btn btn-warning" style="color: #FFFFFF; border-radius: 20px;"> Kaydet </button>
